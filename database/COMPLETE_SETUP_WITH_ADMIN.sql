-- =====================================================
-- Pro Touch Design 데이터베이스 완전 설정 스크립트
-- =====================================================
-- Supabase SQL Editor에서 이 파일 전체를 실행하세요
-- =====================================================
-- 주의: 기존 데이터는 보존되며, 정책만 업데이트됩니다
-- =====================================================
...
-- 사용자 ID: bcdee429-0d46-4e2e-981e-f7038addfdf1
UPDATE users
SET role = 'admin',
    updated_at = NOW()
