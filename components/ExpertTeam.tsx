  ...
  const experts = [
    {
      ...
      image: "/expert-1.png",
      linkedin: "#",
      email: "jimin@protouchdesign.com"
    },
    {
      id: 2,
      name: "박유진",
      ...
      image: "/expert-2.png",
      linkedin: "#",
      email: "seojun@protouchdesign.com"
    },
    {
      id: 3,
      name: "박현우",
    ...
    },
    {
      ...
      image: "/expert-4.png",
      linkedin: "#",
      email: "hyunwoo@protouchdesign.com"
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-white/90 max-w-2xl mx-auto">
            국내 주요 IT 기업 출신의 UX/UI 전문가들이 여러분의 웹사이트를 분석하고 개선 방향을 제시합니다
          </p>
        </div>
          ...
          {experts.map((expert, index) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="text-base font-semibold mb-3" style={{ color: 'var(--accent)' }}>
                  {expert.role}
                </div>
        ...
        {/* Bottom Stats */}
        <div className="grid sm:grid-cols-3 gap-8 mt-16 rounded-2xl p-8 border-2" style={{ background: 'rgba(255,255,255,0.95)', borderColor: 'rgba(255,255,255,0.4)' }}>
          <div className="text-center">
            <div className="text-4xl font-bold mb-2" style={{ color: '#EE6C4D' }}>
              40+
            </div>
